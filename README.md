# 📊 Google Pay India Reviews — User Behaviour & Support Performance Analysis

## 📌 Project Overview

This project analyses real user reviews of **Google Pay India** collected from the Google Play Store.
The goal is not just exploratory data analysis — but to understand:
...
### 1. Product Health
### 2. Reliability Behaviour
### 3. Community Agreement
### 4. Review Behaviour
### 5. Developer Support Behaviour
